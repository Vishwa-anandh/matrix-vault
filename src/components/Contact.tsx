      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <motion.div
            ...
            className="bg-white dark:bg-slate-900 rounded-3xl p-8 lg:p-12 shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800"
          >
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400">contact@maitsys.com</p>
          ...
          >
            ...
            <form className="space-y-6">
              ...
              <button
                type="button"
                className="w-full group relative inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-bold text-white bg-red-600 rounded-xl overflow-hidden transition-all hover:bg-red-700 shadow-lg shadow-red-600/30"
              >
