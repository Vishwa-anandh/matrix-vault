    ...
    <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="w-full h-auto max-sm:aspect-auto sm:aspect-[16/10] bg-[#f8fafc] rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm relative">
      ...
      >
        ...
        <div className="w-1/2 h-full flex flex-col bg-white">
          ...
          <div className="px-5 sm:px-4 pb-4 sm:pb-3 flex items-center gap-2 border-b border-slate-200">
          ...
          <div className="flex-1 overflow-x-auto custom-scrollbar pt-4">
            <div className="min-w-[600px] w-full px-5 sm:px-4 pb-5 sm:pb-4">
              <div className="border border-slate-200 rounded-xl overflow-hidden shadow-sm bg-white">
                <div className="px-4 py-3 sm:py-2 grid grid-cols-12 gap-2 border-b border-slate-200 bg-slate-50 text-[9.4px] sm:text-[6px] font-bold text-slate-600">
                ...
                {[
                  ...
                  <div key={i} className={`px-4 py-3 sm:py-2.5 grid grid-cols-12 gap-2 ${i !== arr.length - 1 ? 'border-b border-slate-200' : ''} text-[10.2px] sm:text-[6.8px] font-semibold text-slate-700 hover:bg-slate-50`}>
        ...
        <div className="w-1/2 h-full flex flex-col bg-white">
          ...
          <div className="px-5 sm:px-4 py-4 sm:py-3 flex items-center gap-2 border-b border-slate-200 text-[10.2px] sm:text-[6.8px]">
          ...
          <div className="flex-1 overflow-x-auto custom-scrollbar pt-4">
            <div className="min-w-[600px] w-full px-5 sm:px-4 pb-5 sm:pb-4">
              <div className="border border-slate-200 rounded-xl overflow-hidden shadow-sm bg-white">
                <div className="px-4 py-3 sm:py-2 grid grid-cols-12 gap-1 border-b border-slate-200 bg-slate-50 text-[9.4px] sm:text-[6px] font-bold text-slate-500">
                  <div className="col-span-1 text-center">#</div>
                ...
                {[
                  ...
                  <div key={i} className={`px-4 py-3 sm:py-2.5 grid grid-cols-12 gap-1 ${i !== arr.length - 1 ? 'border-b border-slate-200' : ''} text-[9.4px] sm:text-[6.4px] font-semibold text-slate-700 items-center hover:bg-slate-50`}>
                    <div className="col-span-1 text-center text-slate-500">{r.n}</div>
    ...
    <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="w-full h-auto max-sm:aspect-auto sm:aspect-[16/10] bg-[#f8fafc] rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm relative">
      ...
      >
        ...
        <div className="w-1/2 h-full flex flex-col bg-[#f8fafc]">
          ...
          {/* Search/Filter bar */}
          <div className="bg-white border-b border-slate-200 px-6 sm:px-4 py-3 sm:py-2.5 flex items-center gap-4 sm:gap-3">
          ...
          {/* Table header */}
          <div className="px-6 sm:px-4 flex-1 overflow-hidden pb-4 pt-4 flex flex-col bg-[#f8fafc]">
            <div className="border border-slate-200 rounded-xl overflow-hidden shadow-sm flex flex-col h-full bg-white">
              <div className="grid grid-cols-12 gap-4 px-4 py-2 sm:py-1.5 bg-slate-50 border-b border-slate-200 text-[10.2px] sm:text-[7.7px] font-bold text-slate-700">
              ...
              {/* Table rows */}
              <div className="flex-1 overflow-y-auto custom-scrollbar bg-white pb-2">
                {[
                  ...
                  <div
                    key={i}
                    className={`grid grid-cols-12 gap-4 px-4 py-3 sm:py-2 items-center ${i !== arr.length - 1 ? 'border-b border-slate-200' : ''}`}
                  >
        ...
        <div className="w-1/2 h-full flex flex-col bg-white">
          ...
          <div className="px-6 sm:px-4 py-5 sm:py-4 flex items-center gap-4 sm:gap-3 border-b border-slate-200">
          ...
          <div className="flex-1 p-5 sm:p-4 overflow-hidden bg-[#f8fafc] pb-2 border-t border-slate-200">
            <div className="grid grid-cols-2 gap-4 sm:gap-3 max-w-[800px] mx-auto">
              {[
                ...
                <div key={i} className="bg-white border border-slate-200 rounded-lg p-4 sm:p-3 shadow-sm flex flex-col gap-3 sm:gap-2">
                  ...
                  <div className="flex flex-col gap-1 mt-1 sm:mt-0">
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded text-[11px] sm:text-[8.5px] font-semibold text-slate-700 px-3 py-1.5 sm:py-1">
                      {card.role}
                    </div>
                  </div>
...
export const SimulationMiniMockup = () => {
  ...
  return (
    <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="w-full h-auto max-sm:aspect-auto sm:aspect-[16/10] bg-[#f8fafc] rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm relative">
      ...
      <div className="bg-white border-b border-slate-200 px-6 sm:px-3 py-4 sm:py-2 flex items-center justify-between shrink-0 z-10 relative shadow-sm">
        <div className="flex items-center gap-3 sm:gap-1.5">
          <div className="w-10 sm:w-8 h-10 sm:h-8 rounded-xl bg-red-50 flex items-center justify-center text-red-600 border border-red-100">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-5 sm:w-4 h-5 sm:h-4 ml-0.5" strokeLinecap="round" strokeLinejoin="round"><polygon points="5 3 19 12 5 21 5 3"></polygon></svg>
          </div>
          <div>
            <div className="text-[18px] sm:text-[14px] font-bold text-slate-900 leading-tight">Role Simulator</div>
            <div className="text-[13px] sm:text-[10px] text-slate-500 font-medium mt-0.5">Test changes before deployment</div>
          </div>
        </div>
      ...
      >
        ...
        <div className="w-1/2 h-full flex flex-col bg-[#f8fafc]">
          ...
          {/* Header Summary */}
          <div className="bg-white px-6 sm:px-4 py-6 sm:py-4 flex max-sm:flex-wrap items-center justify-between border-b border-slate-200 shadow-sm z-10">
          ...
          <div className="flex-1 p-6 sm:p-5 bg-[#f8fafc] flex flex-col overflow-hidden">
            <div className="bg-white border border-slate-200 rounded-xl shadow-sm flex flex-col overflow-hidden">
              <div className="px-6 sm:px-4 py-4 sm:py-3 text-[11.9px] sm:text-[9.4px] font-bold text-slate-800 border-b border-slate-200">
                Potential SoD Conflicts
              </div>
              <div className="px-4 sm:px-2 grid grid-cols-12 gap-1 py-3 sm:py-2 border-b border-slate-200 bg-slate-50 text-[9.4px] sm:text-[6.8px] font-bold text-slate-500">
              ...
              <div className="flex flex-col flex-1 overflow-hidden">
                {[
                  ...
                  <div key={i} className="px-4 sm:px-2 grid grid-cols-12 gap-1 py-4 sm:py-3 border-b border-slate-200 items-center w-full">
              ...
              <div className="px-6 sm:px-4 py-3 sm:py-2.5 bg-slate-50 border-t border-slate-200 text-[10.2px] sm:text-[7.7px] text-slate-500 font-medium shrink-0">
        ...
        <div className="w-1/2 h-full flex flex-col bg-white">
          ...
          {/* Header */}
          <div className="px-6 sm:px-4 py-5 sm:py-3.5 border-b border-slate-200 flex justify-between items-center shadow-sm z-10">
            <div className="flex items-center gap-4 sm:gap-3">
            ...
            <div className="flex gap-3 sm:gap-2">
              <button className="px-4 sm:px-3 py-2 sm:py-1.5 border border-slate-200 rounded-lg text-[11px] sm:text-[8.1px] font-bold text-slate-600 hover:bg-slate-50 flex items-center gap-1.5 shadow-sm"> Cancel</button>
              <button className="px-4 sm:px-3 py-2 sm:py-1.5 bg-indigo-500 rounded-lg text-[11px] sm:text-[8.1px] font-bold text-white hover:bg-indigo-600 flex items-center gap-1.5 shadow-sm"> Save Rule</button>
            </div>
          </div>
          ...
          <div className="flex-1 flex max-sm:flex-col bg-[#f8fafc] p-4 sm:p-5 gap-4 overflow-hidden">
            ...
            <div className="flex-1 min-w-0 bg-white border border-slate-200 rounded-xl p-6 sm:p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex flex-col">
              ...
              <div className="flex max-sm:flex-col items-center gap-4 sm:gap-2 flex-1 min-w-0 overflow-y-auto custom-scrollbar pr-1">
                {/* Block 1 */}
                <div className="flex-1 max-sm:w-full min-w-0 h-full border border-slate-200 rounded-xl p-4 sm:p-3 bg-slate-50 flex flex-col gap-3">
    ...
    <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="w-full h-auto max-sm:aspect-auto sm:aspect-[16/10] bg-[#f8fafc] rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm relative">
      ...
      >
        ...
        <div className="w-1/2 h-full flex flex-col bg-white overflow-hidden shrink-0">
          ...
          {/* Header */}
          <div className="px-6 sm:px-4 py-5 sm:py-4 flex items-center justify-between border-b border-slate-200 z-10 shrink-0">
            <div className="flex items-center gap-4 sm:gap-3">
              <div className="w-10 sm:w-8 h-10 sm:h-8 rounded-xl bg-purple-50 flex items-center justify-center text-purple-600 border border-purple-100">
          ...
          {/* Table */}
          <div className="flex-1 flex flex-col overflow-hidden px-6 sm:px-4 pb-4">
            <div className="border border-slate-200 rounded-xl overflow-hidden shadow-sm flex flex-col h-full bg-white">
              <div className="flex items-center px-4 py-2.5 bg-slate-50 border-b border-slate-200 text-[8.5px] sm:text-[6.4px] font-bold text-slate-500 shrink-0">
              ...
              <div className="flex flex-col overflow-hidden bg-white">
                {[
                  ...
                  <div key={i} className="flex items-center px-4 sm:px-4 py-3 sm:py-2.5 border-b border-slate-200 last:border-b-0">
              ...
              <div className="px-4 py-2 flex items-center justify-between border-t border-slate-200 bg-slate-50/50 shrink-0 mt-auto">
                <span className="text-[9.4px] sm:text-[6.8px] text-slate-500 font-bold">Showing 1 to 3 of 21</span>
        ...
        <div className="w-1/2 h-full flex flex-col bg-slate-50 overflow-hidden shrink-0">
          ...
          {/* Top Stats */}
          <div className="px-6 sm:px-4 py-4 sm:py-3 flex gap-4 sm:gap-3 shrink-0 bg-white border-b border-slate-200">
            <div className="flex-1 border border-slate-200 rounded-lg p-3 sm:p-2 flex items-center gap-3 sm:gap-2 shadow-sm">
          ...
          <div className="px-6 sm:px-4 py-4 sm:py-3 flex-1 flex flex-col overflow-hidden">
            <div className="bg-white border border-slate-200 rounded-lg shadow-sm flex flex-col flex-1 overflow-hidden">
              <div className="px-4 py-3 flex gap-3 border-b border-slate-200 shrink-0">
              ...
              <div className="flex items-center px-4 py-2 bg-slate-50 border-b border-slate-200 text-[8.5px] sm:text-[6.4px] font-bold text-slate-500 shrink-0">
                ...
                <div className="w-[9%] text-center">Evidence</div>
                <div className="w-[11%] text-center">Updated</div>
              ...
              <div className="flex flex-col flex-1 overflow-hidden">
                {[
                  ...
                  <div key={i} className="flex items-center px-4 py-3 sm:py-2 border-b border-slate-200 hover:bg-slate-50 transition-colors">
                    ...
                    <div className="w-[9%] text-[8.5px] sm:text-[6.4px] font-bold text-indigo-600 text-center truncate pr-1">
                      {row.files}
                    </div>
                    <div className="w-[11%] flex flex-col text-[7.7px] sm:text-[5.5px] font-medium text-slate-500 text-center truncate pr-1">
    ...
    <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="w-full h-auto max-sm:aspect-auto sm:aspect-[16/10] bg-[#f8fafc] rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm relative">
      ...
      >
        ...
        <div className="w-1/2 h-full flex flex-col bg-[#f8fafc]">
          ...
          {/* Header */}
          <div className="px-6 sm:px-4 py-4 sm:py-3 bg-white border-b border-slate-200 flex items-center justify-between shrink-0">
            <div className="flex items-center gap-3">
              <div className="w-10 sm:w-8 h-10 sm:h-8 rounded-xl bg-red-50 flex items-center justify-center text-red-600 border border-red-100">
                <Shield className="w-5 sm:w-4 h-5 sm:h-4" />
              </div>
              <div>
                <div className="text-[15.3px] sm:text-[11.9px] font-bold text-slate-900">SoD Violations</div>
                <div className="text-[11px] sm:text-[8.5px] text-slate-500 font-medium mt-0.5">Detect and analyze segregation of duties violations across your critical enterprise systems.</div>
              </div>
            </div>
            <button className="px-3 py-1.5 bg-indigo-600 text-white text-[9.4px] sm:text-[6.8px] font-bold rounded-lg flex items-center gap-1.5 shadow-sm hover:bg-indigo-700">
              New Rule
          ...
          {/* Toolbar */}
          <div className="px-4 py-2 sm:py-1.5 flex items-center gap-2 shrink-0 border-b border-slate-200 bg-slate-50">
          ...
          {/* Table */}
          <div className="p-5 sm:p-4 flex-1 flex flex-col overflow-hidden">
            <div className="flex-1 flex flex-col bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
              <div className="flex items-center gap-1 px-4 py-2 sm:py-1.5 border-b border-slate-200 bg-slate-50 text-[7.7px] sm:text-[6px] font-bold text-slate-500 shrink-0">
              ...
              <div className="flex flex-col overflow-hidden">
                {[
                  ...
                  <div key={i} className="flex items-center gap-1 px-4 py-2 sm:py-1.5 border-b border-slate-200 hover:bg-slate-50 transition-colors relative">
              ...
              {/* Pagination */}
              <div className="px-4 py-2 sm:py-1.5 flex items-center justify-between border-t border-slate-200 bg-white mt-auto shrink-0">
        ...
        <div className="w-1/2 h-full flex flex-col bg-slate-50 overflow-hidden shrink-0">
          ...
          <div className="flex-1 flex flex-col bg-white border border-slate-200 rounded-t-lg mx-4 mt-1 overflow-hidden shadow-sm">
            {/* Toolbar */}
            <div className="px-4 py-2 sm:py-1.5 border-b border-slate-200 flex items-center gap-2">
            ...
            {/* Table Headers */}
            <div className="grid grid-cols-12 gap-1 px-4 py-2 bg-slate-50 border-b border-slate-200 text-[7.7px] sm:text-[6px] font-bold text-slate-500">
            ...
            <div className="flex flex-col flex-1 overflow-hidden">
              {[
                ...
                <div key={i} className="grid grid-cols-12 gap-1 px-4 py-2 sm:py-1.5 border-b border-slate-200 items-center hover:bg-slate-50 transition-colors">
    ...
    <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="w-full aspect-[16/10]  aspect-[16/10] bg-[#f8f9fa] rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm relative">
      ...
      >
        ...
        <div className="w-1/2 h-full flex flex-col bg-[#f8f9fa] overflow-hidden shrink-0 relative">
          {/* <div className="bg-white border-b border-slate-200 flex items-center justify-end px-3 py-2 shrink-0">
            <div className="flex items-center gap-1">
            ...
            <div className="max-w-4xl mx-auto flex flex-col gap-1.5">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="flex flex-col">
                  <h1 className="text-[12.8px] sm:text-[10.2px] font-extrabold tracking-tight">New Requests</h1>
                  <p className="text-[8px] sm:text-[6.4px] font-medium mt-0.5">Submit access request for approval</p>
                </div>
              </div>
              {/* Access System Panel */}
          ...
          <div className="flex-1 overflow-hidden p-3">
            <div className="max-w-4xl mx-auto flex flex-col gap-2.5">
              ...
              <div className="bg-white border-l-4 border-l-emerald-500 border-y border-r border-slate-200 rounded-xl sm:rounded-md p-2.5 flex gap-3 shadow-sm">
                <div className="flex flex-col gap-1 shrink-0 w-20 border-r border-slate-200 pr-2">
                ...
                <div className="flex-1 flex flex-col gap-1.5 min-w-0 border-r border-slate-200 pr-2">
...
export const WorkspaceReportingMiniMockup = () => (
  <div className="w-full aspect-[16/10] bg-[#f8f9fa] rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm relative">
    ...
    {/* Main Content */}
    <div className="flex flex-1 overflow-hidden bg-white border-t border-slate-200">
      {/* Left Sidebar */}
      ...
      {/* Main Content Area */}
      <div className="flex-1 flex flex-col bg-[#fdfdfd] overflow-hidden border-t border-slate-200">
        {/* Header Section */}
        <div className="p-4 border-b border-slate-200 flex flex-col gap-2 bg-white">
        ...
        {/* Tabs */}
        <div className="flex items-center px-4 gap-6 border-b border-slate-200 bg-white">
        ...
        <div className="flex-1 p-4 bg-slate-50 overflow-hidden flex flex-col gap-2">
          ...
          {/* Row */}
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-3 grid grid-cols-12 gap-2 items-start">
...
export const SessionMonitoringMiniMockup = () => (
  <div className="w-full h-auto max-sm:aspect-auto sm:aspect-[16/10] bg-[#f8fafc] rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden custom-scrollbar shadow-sm">
    ...
    <div className="flex flex-1 overflow-hidden bg-[#f8fafc] p-4 sm:p-2 gap-4 sm:gap-2 border-t border-slate-200">
      {" "}
      {/* Sidebar */}{" "}
      <div className="w-1/3 border border-slate-200 rounded-xl bg-slate-50 flex flex-col overflow-hidden shadow-sm">
        {" "}
        ...
        <div className="p-4 sm:p-2 border-b border-slate-200 flex justify-between items-center bg-white border-l-2 border-l-red-500">
          {" "}
        ...
        <div className="p-4 sm:p-2 border-b border-slate-200 flex justify-between items-center hover:bg-white transition-colors cursor-pointer">
          {" "}
          <span className="text-[12.8px] sm:text-[5.1px] font-bold text-slate-700">
            HR Module
          </span>{" "}
      ...
      {/* Main Content */}{" "}
      <div className="flex-1 border border-slate-200 rounded-xl overflow-hidden shadow-sm flex flex-col h-full bg-white p-4 sm:p-2 gap-3 sm:gap-1.5">
...
export const SafeguardsAuditMiniMockup = () => (
  <div className="w-full aspect-[16/10] bg-white rounded-xl border border-slate-200 shadow-sm flex flex-col font-sans overflow-hidden relative">
    ...
    <div className="flex flex-1 overflow-hidden bg-[#f8fafc] p-4 sm:p-2 gap-4 sm:gap-2 border-t border-slate-200">
      {/* Left Sidebar */}
      <div className="w-[30%] bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm flex flex-col shrink-0">
        <div className="p-2 sm:p-1.5 border-b border-slate-200">
        ...
        <div className="p-2 sm:p-1.5 flex items-center justify-between border-b border-slate-200 text-[14.9px] sm:text-[7.7px] font-bold text-slate-600">
      ...
      {/* Right Content */}
      <div className="flex-1 border border-slate-200 rounded-xl overflow-hidden shadow-sm flex flex-col h-full bg-white">
        {/* Header */}
    ...
    <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="w-full h-auto max-sm:aspect-auto sm:aspect-[16/10] bg-slate-50 rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm relative">
      ...
      >
        ...
        <div className="w-1/2 h-full flex flex-col bg-[#f8fafc]">
          ...
          <div className="p-4 flex flex-col h-full">
            ...
            <div className="bg-white border border-slate-200 rounded-lg shadow-sm flex overflow-hidden">
              {/* Left Col */}
              <div className="w-[20%] p-3 border-r border-slate-200 flex flex-col gap-2">
                <div className="flex items-center gap-2">
              ...
              {/* Right Col */}
              <div className="w-[25%] bg-[#f4fafa] p-3 border-l border-slate-200 flex flex-col gap-2">
        ...
        <div className="w-1/2 h-full flex flex-col bg-[#f8fafc]">
          ...
          <div className="bg-white border-b border-slate-200 flex items-center justify-start px-3 py-2 shrink-0">
            <div className="flex items-center gap-1.5">
              <div className="w-5 h-5 bg-red-50 text-red-500 rounded flex items-center justify-center shrink-0">
                <Activity className="w-3 h-3" />
              </div>
              <div className="flex flex-col">
                <h1 className="text-[8px] sm:text-[6.4px] font-extrabold tracking-tight leading-tight text-slate-900">Access Request</h1>
                <p className="text-[6.5px] sm:text-[5.2px] text-slate-500 font-medium mt-0.5">Manage and track request approvals</p>
              </div>
            </div>
          </div>
    ...
    <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="w-full h-auto max-sm:aspect-auto sm:aspect-[16/10] bg-[#f8fafc] rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm relative">
      ...
      >
        ...
        <div className="w-1/2 h-full flex flex-col bg-white">
          ...
          <div className="bg-white px-6 sm:px-4 py-5 sm:py-4 flex items-center justify-between border-b border-slate-200 shrink-0">
            <div className="flex items-center gap-4 sm:gap-3">
              <div className="w-10 sm:w-8 h-10 sm:h-8 rounded-xl bg-purple-50 flex items-center justify-center text-purple-600 border border-purple-100">
                <Shield className="w-5 sm:w-4 h-5 sm:h-4" />
              </div>
          ...
          <div className="p-5 sm:p-4 bg-[#f8fafc] flex-1 flex flex-col gap-4 sm:gap-3 overflow-hidden">
            ...
            <div className="flex-1 bg-white border border-slate-200 rounded-xl shadow-sm flex flex-col overflow-hidden">
              <div className="grid grid-cols-12 gap-2 px-5 sm:px-4 py-3 sm:py-2.5 border-b border-slate-200 bg-slate-50 text-[9.4px] sm:text-[6.8px] font-bold text-slate-500">
              ...
              <div className="flex-1 overflow-hidden">
                {[
                  ...
                  <div key={i} className="grid grid-cols-12 gap-2 px-5 sm:px-4 py-4 sm:py-3 border-b border-slate-200 items-center hover:bg-slate-50 text-[10.2px] sm:text-[8.1px]">
    ...
    <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="w-full h-auto aspect-[16/10] bg-white rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm relative">
      ...
      >
        ...
        <div className="w-1/2 h-full flex flex-col bg-white">
          ...
          <div className="flex flex-wrap items-center justify-between px-3 py-2 border-b border-slate-200 shrink-0 gap-2">
          ...
          <div className="flex flex-1 overflow-hidden p-2 gap-2">
            ...
            <div className="w-[30%] flex flex-col gap-1 border-r border-slate-200 pr-2 overflow-y-auto custom-scrollbar">
            ...
            <div className="flex-1 flex flex-col gap-2 relative min-w-0">
              ...
              {/* Alerts List */}
              <div className="flex flex-col border border-slate-200 rounded-lg overflow-y-auto custom-scrollbar flex-1 min-w-0">
                <div className="bg-slate-50/80 px-2.5 py-1 text-[9.6px] font-bold text-slate-500 border-b border-slate-200 sticky top-0 z-10">Today</div>
                <div className="flex items-center px-2.5 py-1.5 border-b border-slate-200 hover:bg-slate-50 cursor-pointer min-w-0 gap-1.5">
                ...
                <div className="bg-slate-50/80 px-2.5 py-1 text-[9.6px] font-bold text-slate-500 border-b border-slate-200 sticky top-0 z-10">Yesterday</div>
                <div className="flex items-center px-2.5 py-1.5 border-b border-slate-200 hover:bg-slate-50 cursor-pointer min-w-0 gap-1.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-red-500 shrink-0"></div>
                  <div className="w-4 h-4 rounded-full bg-red-50 flex items-center justify-center text-red-500 shrink-0"><Activity className="w-2 h-2" /></div>
                ...
                {/* <div className="bg-slate-50/80 px-2.5 py-1 text-[9.6px] font-bold text-slate-500 border-b border-slate-200 sticky top-0 z-10">This Week</div>
                <div className="flex items-center px-2.5 py-1.5 border-b border-slate-200 hover:bg-slate-50 cursor-pointer min-w-0 gap-1.5">
        ...
        <div className="w-1/2 h-full flex flex-col bg-[#fcfcfc]">
          ...
          <div className="flex flex-wrap items-center justify-between px-3 py-2 border-b border-slate-200 shrink-0 bg-white shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] z-10 relative gap-2">
            <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="flex flex-1 overflow-hidden p-2 gap-2 min-w-0">
            {/* Left Sidebar */}
            <div className="w-[30%] flex flex-col gap-1.5 border border-slate-200 rounded-lg bg-white p-2 shadow-sm overflow-y-auto custom-scrollbar">
              ...
              <div className="bg-emerald-50/30 border-l-2 border-emerald-500 border-t border-r border-b border-slate-200 rounded-r-md p-1.5 flex flex-col gap-1.5 cursor-pointer shadow-[0_2px_8px_-4px_rgba(16,185,129,0.3)] shrink-0 min-w-0">
              ...
              <div className="bg-white border border-slate-200 rounded-md p-1.5 flex flex-col gap-1.5 cursor-pointer hover:border-slate-200 transition-colors shrink-0 min-w-0">
                <div className="flex items-center justify-between gap-1 min-w-0">
                  <div className="flex items-center gap-1 min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-0.5 text-[8.8px] font-bold text-slate-500">
                  <span className="bg-slate-50 border border-slate-200 px-1 rounded truncate">SU01</span>
                  <span className="bg-slate-50 border border-slate-200 px-1 rounded truncate">SU10</span>
                  <span className="bg-slate-50 border border-slate-200 px-1 rounded">+2</span>
                </div>
                <div className="flex items-center gap-1 text-[8.8px] text-slate-500 font-medium mt-0.5 truncate">
            ...
            <div className="flex-1 flex flex-col gap-2 min-w-0">
              {/* Rule Detail Card */}
              <div className="bg-white border border-slate-200 shadow-sm rounded-lg p-2.5 flex flex-col relative shrink-0 min-w-0">
    ...
    <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="w-full h-auto max-sm:aspect-auto sm:aspect-[16/10] bg-[#f8fafc] rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm relative">
      ...
      >
        ...
        <div className="w-1/2 h-full flex flex-col bg-white">
          ...
          <div className="bg-white px-6 sm:px-4 py-5 sm:py-4 flex items-center justify-between border-b border-slate-200 shrink-0">
            <div className="flex items-center gap-4 sm:gap-3">
              <div className="w-10 sm:w-8 h-10 sm:h-8 rounded-xl bg-slate-50 flex items-center justify-center text-slate-500 border border-slate-200">
        ...
        <div className="w-1/2 h-full flex flex-col bg-white">
          ...
          <div className="p-5 sm:p-4 bg-[#f8fafc] flex-1 flex flex-col overflow-hidden">
            <div className="flex-1 bg-white border border-slate-200 rounded-xl shadow-sm flex flex-col overflow-hidden">
              <div className="flex items-center px-5 sm:px-4 py-3 sm:py-2.5 border-b border-slate-200 bg-slate-50 text-[9.4px] sm:text-[6.8px] font-bold text-slate-500">
                <div className="w-[12%] pr-2 truncate">Component</div>
                <div className="w-[14%] pr-2 truncate">System</div>
                <div className="w-[8%] pr-1 truncate">Release</div>
                <div className="w-[10%] leading-tight pr-1 truncate">Latest Rel.</div>
                <div className="w-[8%] leading-tight pr-1 truncate">SP Level</div>
                <div className="w-[18%] leading-tight pr-2 truncate">Support Package Stack</div>
                <div className="w-[13%] pr-2 truncate">Status</div>
                <div className="w-[17%] truncate">Description</div>
              </div>
              <div className="flex-1 overflow-hidden">
                {[
                  ...
                  <div key={i} className="flex items-center px-5 sm:px-4 py-4 sm:py-3 border-b border-slate-200 hover:bg-slate-50 text-[10.2px] sm:text-[8.1px]">
                    <div className="w-[12%] font-bold text-slate-800 pr-2 truncate">{row.comp}</div>
                    <div className="w-[14%] text-slate-600 font-medium pr-2 truncate">{row.sys}</div>
                    <div className="w-[8%] text-slate-600 pr-1 truncate">{row.rel}</div>
                    <div className="w-[10%] text-slate-800 font-bold pr-1 truncate">{row.lat}</div>
                    <div className="w-[8%] text-slate-600 pr-1 truncate">{row.sp}</div>
                    <div className="w-[18%] font-mono text-[9.4px] sm:text-[6.8px] text-slate-500 pr-2 truncate">{row.stack}</div>
                    <div className={`w-[13%] font-bold flex items-center gap-1.5 pr-2 truncate ${row.status === "Update Available" ? "text-amber-600" : "text-slate-600"}`}>
                      <span className="truncate">{row.status}</span>
                    </div>
                    <div className="w-[17%] text-slate-500 truncate">{row.desc}</div>
                  </div>
                ))}
              </div>
            </div>
  ...
  <div className="w-full h-auto max-sm:aspect-auto sm:aspect-[16/10] bg-[#f8fafc] rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm">
    ...
    <div className="flex flex-1 min-h-0">
      ...
      <div className="w-2/3 min-w-0 bg-white p-4 sm:p-2">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded p-3 sm:p-1.5 flex gap-3 sm:gap-1.5 items-start">
    ...
    <div onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} className="w-full h-auto max-sm:aspect-auto sm:aspect-[16/10] bg-[#f8fafc] rounded-xl border border-slate-200 flex flex-col font-sans overflow-hidden shadow-sm relative">
      ...
      >
            ...
            <div className="bg-white border border-slate-200 rounded overflow-hidden flex-1 flex flex-col shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
              ...
              <div className="flex-1 overflow-hidden">
                {[
                  ...
                  <div key={i} className={`grid grid-cols-12 gap-2 sm:gap-1 px-4 sm:px-2 py-2 sm:py-1.5 border-b border-slate-200 text-[16.1px] sm:text-[4.3px] items-center hover:bg-slate-50 transition-colors`}>
        ...
        <div className="w-1/2 h-full flex flex-col bg-white overflow-hidden">
          ...
          {/* Modal Header */}
          <div className="px-4 py-2 sm:px-3 sm:py-1.5 border-b border-slate-200 flex justify-between items-center shrink-0">
          ...
          {/* Modal Footer */}
          <div className="px-4 py-2 sm:px-3 sm:py-1.5 border-t border-slate-200 flex justify-end gap-2 bg-white shrink-0">
