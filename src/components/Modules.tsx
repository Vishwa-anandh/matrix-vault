...
const RoleRadarMockup = () => (
  <div className="mockup-readable-text w-full bg-white text-slate-500 rounded-t-2xl flex flex-col font-sans overflow-hidden border border-slate-200 shadow-2xl h-full">
    ...
    <div className="bg-white border-b border-slate-200 px-3 py-2 flex items-center justify-between text-[10px] font-medium shrink-0">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="font-extrabold text-slate-900 tracking-tight text-[9px] sm:text-[11px]">MATRIXVAULT</span>
        </div>

        {/* Menu items */}
        <div className="hidden sm:flex items-center gap-1.5 sm:gap-3 text-slate-500 font-bold text-[6px] sm:text-[10px]">
          ...
          <span className="flex items-center gap-0.5 hover:text-slate-900 transition-colors cursor-pointer">Governance <span className="bg-red-50 text-red-600 border border-red-200 px-1 py-0.2 rounded-full text-[5px] sm:text-[7px]">99+</span></span>
          ...
          <span className="flex items-center gap-0.5 hover:text-slate-900 transition-colors cursor-pointer">Vulnerabilities <span className="bg-red-50 text-red-600 border border-red-200 px-1 py-0.2 rounded-full text-[5px] sm:text-[7px]">17</span></span>
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        <div className="flex items-center gap-1.5 pl-1.5 border-slate-200">
          <div className="w-5 h-5 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center font-bold text-[8px] text-slate-600">J</div>
        </div>
      </div>
    </div>
    ...
    <div className="bg-slate-50 border-b border-slate-200 px-3 py-2 flex flex-col md:flex-row items-start md:items-center justify-between shrink-0 gap-2 md:gap-0">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="text-[8px] text-red-600 bg-red-50 px-2 py-0.5 rounded-full font-bold flex items-center gap-1 border border-red-100 max-w-full">
          ...
          <span className="truncate text-[6px] sm:text-[8px]">980 critical findings require immediate attention</span>
          <span className="text-slate-500 font-normal shrink-0 text-[6px] sm:text-[8px]">· Last scan: 9m ago</span>
        </div>
      </div>
    ...
    <div className="p-3 pb-0 flex flex-col gap-3 flex-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-10 gap-3 mb-2">
        ...
        <div className="col-span-1 lg:col-span-6 bg-white border border-slate-200 rounded-xl p-3 flex flex-col shadow-sm">
          ...
          <div className="space-y-1">
            {[
              ...
              <div className="flex flex-row items-center justify-between border border-slate-100 hover:bg-slate-50 p-1.5 rounded transition-colors text-[7px] gap-2 sm:gap-0">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <span className="font-bold text-slate-900 text-[6px] sm:text-[7px]">Create User and Assign Role</span>
                    <div className="text-[5px] sm:text-[6px] text-slate-500 flex flex-wrap items-center gap-1 mt-0.5">
                      <span className="font-bold text-slate-600">{f.role}</span>
                      <span className="bg-white text-slate-600 px-1 py-0.2 rounded font-mono border border-slate-200 shadow-sm">{f.sys}</span>
                    </div>
                  </div>
                </div>
        ...
        <div className="col-span-1 lg:col-span-4 bg-white border border-slate-200 rounded-xl p-3 flex flex-col shadow-sm">
          <div className="flex items-center justify-between border-b border-slate-100 pb-1.5 mb-2">
            <span className="text-[8px] font-bold text-slate-900">Top Risk Users <span className="text-slate-500 font-normal text-[6px] sm:text-[8px]">— by open findings</span></span>
          ...
          <div className="space-y-1">
            {[
              ...
              <div className="flex items-center justify-between p-1 border-b border-slate-100 last:border-0 text-[7px] flex-nowrap gap-1 sm:gap-0">
                <div className="flex items-center gap-1 sm:gap-2">
                  <span className="text-slate-400 font-black shrink-0">{i + 1}</span>
                  <div>
                    <span className="font-extrabold text-slate-900 text-[6px] sm:text-[7px]">{u.name}</span>
                    <div className="text-[5px] sm:text-[6px] text-slate-500 truncate">MSQ System · 9m ago</div>
                  </div>
                </div>
                <div className="flex items-center gap-1 font-mono font-bold text-[5px] sm:text-[6px] shrink-0">
                  <span className="text-red-600 bg-red-50 px-1 rounded border border-red-100">66C</span>
                  <span className="text-amber-600 bg-amber-50 px-1 rounded border border-amber-100">23H</span>
...
const FirefighterMockup = () => (
  <div className="mockup-readable-text w-full sm:aspect-[4/3] bg-white rounded-t-2xl flex flex-col font-sans overflow-hidden border-b border-slate-200 shadow-2xl">
    {/* Header */}
      ...
      <div className="flex-1 bg-white border border-slate-200 rounded-xl p-3 md:p-5 flex flex-col shadow-sm relative z-10">
        <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-4 gap-2 sm:gap-0">
          ...
          <div className="flex gap-2.5 items-center">
            <div className="h-7 w-20 sm:w-28 bg-slate-100 rounded-lg animate-pulse"></div>
            <div className="h-7 px-2 sm:px-3 bg-orange-50 border border-orange-200 rounded-lg flex items-center justify-center text-[8px] sm:text-[10px] text-orange-600 font-bold tracking-wider cursor-pointer hover:bg-orange-100 transition-colors shrink-0 shadow-sm">New Request</div>
          </div>
        </div>

        <div className="flex-1 flex flex-col gap-2">
          {/* Table Header */}
          <div className="grid grid-cols-4 gap-1 sm:gap-2 px-1 sm:px-3 py-2 border-b border-slate-100 text-[6px] sm:text-[9px] font-black text-slate-500 tracking-widest">
            <span>User</span>
          ...
          {[
            ...
            <div key={i} className="grid grid-cols-4 gap-1 sm:gap-2 px-1 sm:px-3 py-2 sm:py-3 bg-white hover:bg-slate-50 border border-slate-100 rounded-lg text-[8px] sm:text-[11px] transition-colors items-center group cursor-pointer shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
              <span className="text-slate-900 font-bold group-hover:text-orange-600 transition-colors truncate">{row.user}</span>
              <span className="text-slate-600 font-mono text-[7px] sm:text-[10px] bg-slate-50 px-1 sm:px-1.5 py-0.5 rounded border border-slate-200 w-fit">{row.sys}</span>
              <span className={`font-mono font-bold ${row.time === 'Expired' ? 'text-red-600' : 'text-slate-500'}`}>{row.time}</span>
              <span className="flex items-center gap-1 sm:gap-2">
                <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full shrink-0 ${row.dot} ${row.status === 'Active' ? 'animate-pulse' : ''}`}></div>
                <span className="text-slate-700 font-bold truncate">{row.status}</span>
              </span>
            </div>
          ))}
        </div>
...
export function Modules() {
  ...
  const VulnerabilitiesMainMockup = () => (
    <div className="mockup-readable-text w-full bg-white text-slate-500 rounded-t-2xl flex flex-col font-sans overflow-hidden border border-slate-200 shadow-2xl h-full">
      {/* Header */}
      <div className="bg-slate-50 border-b border-slate-200 px-3 sm:px-4 py-3 flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:p-2 shrink-0">
        <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-4 sm:p-2 bg-white border border-slate-200 rounded-lg px-2.5 py-1 text-[9px] sm:text-xs text-slate-700 font-bold whitespace-nowrap self-start sm:self-auto shadow-sm">
      ...
      <div className="flex-1 p-3 sm:p-4 bg-white flex flex-col gap-3 overflow-hidden relative">
        {/* Top Cards Grid */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:p-1.5 sm:gap-4 sm:p-2">
          {[
            ...
            <div key={i} className={`border ${c.border} rounded-lg p-4 sm:p-2 sm:p-2.5 flex flex-col shadow-sm`}>
        ...
        {/* Module Status */}
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 sm:p-2.5 sm:p-3 w-full overflow-hidden shadow-sm">
          <div className="text-[9px] sm:text-[10px] font-extrabold text-slate-900 mb-2.5 flex items-center gap-4 sm:p-2">
          ...
          <div className="pb-1 sm:pb-0">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:p-1.5">
              {[
                { label: 'Profile Param...', val: '110', sub: '3 profiles', red: false },
                { label: 'Scan RFC Health', val: '39', sub: '25 ok · 0 unchecked', red: true },
                { label: 'Certificate Check', val: '17', sub: '0 expiring soon', green: true },
                { label: 'Installed Products', val: '5', sub: 'of 6 products', orange: true },
              ].map((m, i) => (
                <div key={i} className="w-full bg-white border border-slate-200 rounded-lg p-3 sm:p-1.5 sm:p-2 flex flex-col cursor-pointer hover:bg-slate-50 hover:border-slate-300 transition-colors shrink-0 shadow-sm">
                  <div className="text-[13px] sm:text-[6px] sm:text-[7px] text-slate-500 font-bold mb-1 whitespace-nowrap overflow-hidden text-ellipsis">{m.label}</div>
                  ...
                  <div className="text-[13px] sm:text-[6px] sm:text-[7px] text-red-600 font-bold">Click to view</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
          {/* Status Breakdown */}
          <div className="flex flex-col gap-3 sm:p-1.5">
            <div className="text-[9px] sm:text-[10px] font-extrabold text-slate-900">Status Breakdown</div>
            <div className="grid grid-cols-2 gap-3 sm:p-1.5">
              {[
          ...
          <div className="flex flex-col gap-3 sm:p-1.5">
            ...
            <div className="bg-white border border-slate-200 rounded-lg p-3 flex flex-col justify-center gap-4 sm:p-2.5 h-full shadow-sm">
              {[
