      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-300 text-lg mb-8 font-medium leading-relaxed">
          ...
          >
            ...
            <img 
              ...
              loading="lazy"
              className="relative rounded-3xl shadow-2xl border-4 border-white dark:border-slate-800 object-cover object-center h-[320px] sm:h-[420px] lg:h-[500px] w-full"
            />
            {/* Floating badge */}
