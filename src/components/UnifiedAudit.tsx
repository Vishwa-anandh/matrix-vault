        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 pb-6 border-b border-slate-100 dark:border-slate-800 gap-4">
            <div className="min-w-0">
              <h3 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white mb-1 break-words">REQ-2023-8942: Access for Lucas Ferreira</h3>
            ...
            <div className="col-span-1 md:col-span-1 space-y-6">
              ...
              <div className="flex items-center gap-3 text-slate-700 dark:text-slate-200">
                ...
                <div className="min-w-0">
                  ...
                  <div className="font-medium text-sm text-green-600 dark:text-green-400">Sarah Miller (Security)</div>
                </div>
              </div>
            </div>
