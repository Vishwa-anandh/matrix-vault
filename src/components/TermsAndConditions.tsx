          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
            ...
            <div className="lg:w-1/4 shrink-0">
              <div className="sticky top-24">
                ...
                <nav className="flex flex-col space-y-2 border-l border-slate-200 dark:border-slate-800">
                  <a href="#about-matrixvault" className="pl-4 text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-red-600 dark:hover:text-red-400 hover:border-red-600 dark:hover:border-red-500 transition-colors border-l border-transparent -ml-px py-1">About MatrixVault</a>
            ...
            <div className="lg:w-3/4">
              ...
              >
                ...
                <h2 id="about-matrixvault" className="text-2xl font-bold mt-12 mb-6 scroll-mt-24">1. About MatrixVault
                </h2>
